import { _, render, Events, onClick, withNextFrame, statelessComponent, component, TrackByKey, key, useMutationEffect, getDOMNode } from "ivi";
...
const Cell = statelessComponent(({ className, children }) => td(className, _, children));
const Row = statelessComponent((data) =>
  tr(_, _, [
    Cell({ className: "col-md-1", children: data.id }),
    Cell({ className: "col-md-4", children: a(_, _, data.label) }),
    Cell({ className: "col-md-1", children: a(_, _, removeIcon()) }),
