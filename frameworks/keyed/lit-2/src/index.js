...
class Row extends HTMLTableRowElement {
  connectedCallback() {
    this.renderCells = () => render(html`<td class="col-md-1">${this.id}</td>
    <td class="col-md-4"><a>${this._label}</a></td>
    <td class="col-md-1" data-interaction='delete'><a><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
    <td class="col-md-6"></td>`, this);
    this.renderCells();
  }
