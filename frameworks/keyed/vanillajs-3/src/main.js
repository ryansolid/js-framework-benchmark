...
class BenchmarkApp extends HTMLDivElement {
  constructor() {
    ...
    const preloadIcon = document.createElement("span", { is: "remove-icon" });
    preloadIcon.preload = true;
...
class BenchmarkRow extends HTMLTableRowElement {
  constructor() {
    ...
    const span = document.createElement("span", { is: "remove-icon" });
    span.preload = false;
...
function td(className) {
  const td = document.createElement("td", { is: "benchmark-cell" });
